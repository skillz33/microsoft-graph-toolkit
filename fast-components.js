...
const DI = Object.freeze({
  ...
  getOrCreateDOMContainer(node = document.body, config) {
    return node.$$container$$ || new ContainerImpl(node, Object.assign({}, ContainerConfiguration.default, config, {
      parentLocator: node === document.body ? () => null : DI.findParentContainer
    }));
  },
...
__decorate([attr({
  attribute: "label"
})], PickerList.prototype, "label", void 0);

__decorate([attr({
  attribute: "labelledby"
})], PickerList.prototype, "labelledby", void 0);
...
class Picker extends FormAssociatedPicker {
  constructor() {
    ...
    this.handleMenuOptionsUpdated = e => {
      e.preventDefault();
    ...
    this.disableMenu = () => {
      ...
      (_b = (_a = this.listElement) === null || _a === void 0 ? void 0 : _a.inputElement) === null || _b === void 0 ? void 0 : _b.removeAttribute("aria-activedescendant");
      (_d = (_c = this.listElement) === null || _c === void 0 ? void 0 : _c.inputElement) === null || _d === void 0 ? void 0 : _d.removeAttribute("aria-owns");
      (_f = (_e = this.listElement) === null || _e === void 0 ? void 0 : _e.inputElement) === null || _f === void 0 ? void 0 : _f.removeAttribute("aria-expanded");
    };
    /**
    ...
    this.setFocusedOption = optionIndex => {
      ...
      this.listElement.inputElement.setAttribute("aria-activedescendant", this.menuFocusOptionId);
...
const pickerMenuOptionTemplate = (context, definition) => {
  return html`<template role="listitem" tabindex="-1" @click="${(x, c) => x.handleOptionClick(c.event)}"><slot></slot></template>`;
};
...
const pickerListTemplate = (context, definition) => {
  return html`<template slot="list-region" role="list" class="picker-list"><input role="combobox" type="text" autocapitalize="off" autocomplete="off" haspopup="list" class="input-element" aria-label="${x => x.label}" aria-labelledby="${x => x.labelledby}" ${ref("inputElement")}></input><slot></slot></template>`;
};
...
const pickerListItemTemplate = (context, definition) => {
  return html`<template role="listitem" tabindex="0" @click="${(x, c) => x.handleItemClick(c.event)}" @keydown="${(x, c) => x.handleItemKeyDown(c.event)}"><slot></slot></template>`;
};
